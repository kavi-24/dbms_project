...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\srika\Desktop\VIT\5th sem\DBMS\Theory\DA\dbms_project'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\srika\Desktop\VIT\5th sem\DBMS\Theory\DA\dbms_project\Scripts\deactivate.nu'
